...
class TestReflection
{
	 ...
	 *
	 * @param	object	$object	  * @param	string	$propertyName	  *
	 ...
	 *
	 * @param	object	$object	  * @param	string	$methodName	  *
	 * @return  mixed
	 *
	 * @since   11.3
	 */
	 ...
	 *
	 * @param	object	$object	  * @param	string	$propertyName	  * @param	mixed	$value	  *
	 * @return  void
	 *
	 * @since   11.3
	 */
