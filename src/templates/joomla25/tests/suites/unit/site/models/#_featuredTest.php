...
<?php
/**
 * {{ project.title }} {{ entity.name | title }} Featured Items Controller Tests
 *
 * PHP version 5.3
 *
{# align("\t", '  ') #}
...
require_once SOURCE_DIR . '/site/models/{{ entity.name | singular | file }}_featured.php';

/**
 * Tests for Frontpage Component Model
 *
{# align("\t", '  ') #}
...
{# endalign #}
 */
class {{ project.name | class }}ModelFeaturedTest extends PHPUnit_Framework_TestCase
{
    /**
     * The object under test
     *
     * @var  {{ project.name | class }}ModelFeatured
     */
    protected $object;
    ...
    {
        $this->object = new {{ project.name | class }}ModelFeatured;
    }
